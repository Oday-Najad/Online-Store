...
<html>
    <head>
        ...
        <title>Welcome to Raneem Store</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            ...
            <footer class="footer">
               <div class="container">
               <center>
                   <p>Copyright &copy <a href="#">Raneem Store</a>. All Rights Reserved.</p>
                   <p>This website is developed by Raneem Ali</p>
               </center>
               </div>
           </footer>
        </div>
